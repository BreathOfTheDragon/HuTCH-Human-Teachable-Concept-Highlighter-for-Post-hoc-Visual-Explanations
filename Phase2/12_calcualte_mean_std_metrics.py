...
file_path = "./highlighted_saliency_overlap/iou_dice_results_saliency.csv"  # Replace with your file path
...
results_csv_path = os.path.join(overlap_dir, "iou_dice_stats_saliency.csv")
